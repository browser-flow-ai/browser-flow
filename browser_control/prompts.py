...
def build_act_observe_prompt(
    ...
    instruction = (
        ...
        f"**IMPORTANT**: If the user requests scrolling to a position on the page, such as \"halfway\" or 0.75, you must format the parameter as the correct percentage, such as \"50%\" or \"75%\"."
        f"**IMPORTANT**: If the user requests scrolling to the next/previous chunk, ALWAYS choose the nextChunk/prevChunk method on the scrollable container (usually /html[1] or /html[1]/body[1]). Do NOT choose click operations on pagination links. No parameters are needed here."
